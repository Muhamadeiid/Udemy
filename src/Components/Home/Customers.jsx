  ...
  return (
    <>
      <div className="customers mb-16 flex flex-col md:gap-8 bg-[#f7f9fa] py-12 shadow-md gap-2">
        <div className="relative border bg-white flex justify-between m-auto w-[350px] lg:w-[800px] md:w-[600px] p-8">
          <div className="text flex flex-col justify-between items-start">
            <p className=" max-w-96 sm:text-base text-sm">
            ...
            <button className="text-maincolor font-bold sm:text-base text-sm">
              Read Full Story
            </button>
          </div>
          <div className="person flex flex-col items-center justify-start sm:text-base text-xs">
          ...
          <FaArrowCircleRight
            size={40}
            className="bg-white absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2"
          />
        </div>
        <button className="text-maincolor font-bold sm:text-base text-sm">
